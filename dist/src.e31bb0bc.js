...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      return [(0, _utils.block)('Введите текст'), (0, _utils.block)('Введите заголовок')].join('');
    }
  }, {
    key: "addBlock",
...
var model = [new _bloks.TitleBlock('Конструктор сайтов на чистом JavaScript', {
  tag: 'h2',
  styles: {
  ...
  alt: 'Это картинка'
}), new _bloks.TextBlock('Нью-Йорк (New York City или City of New York) - мегаполис мирового значения и крупнейший город в США с населением свыше 8,3 миллиона человек. Является экономическим и финансовым центром Соединенных Штатов Америки, а так же одним из самых известных городов в мире.', {
  styles: {
...
}), new _bloks.ColumsBlock(['Основанный голландскими колонистами, этот город изначально назывался Новым Амстердамом.', 'В одноимённом штате Нью-Йорк используется всего 8 различных дорожных знаков.', 'Небоскрёбов в этом городе больше, чем в любом другом. Больше даже, чем в Сингапуре или Гонконге.'], {
  styles: {
    padding: '2rem',
    color: '#161513'
  }
